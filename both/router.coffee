...
publicRoutes = _.union Config.publicRoutes, ['entrySignIn','entrySignUp','entryForgotPassword','requestQuote','privacy','terms']
...
Router.onBeforeAction signInProhibited, {only: ['entrySignUp','entrySignUp','entryForgotPassword','requestQuote','privacy','terms']}
